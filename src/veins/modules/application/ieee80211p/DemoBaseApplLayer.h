...
protected:
    ...
    virtual void UpdateNNT(DemoSafetyMessage* bsm);
      /**
                * @REENVIO DEL MSG RECIBIDO en caso de ser un nodo || en caso de un rsu enviar respuesta con CS selected
                *
                * @param
                *        */
    virtual void PreparaBeaconValues(DemoSafetyMessage* bsm);
      /**
...
protected:
   ...
   //bool Use_BandwidthEstimation_Metric;
   //int Packet_Size;
